...
openai_client = OpenAI(api_key=config.require("OPENAI_API_KEY", config.OPENAI_API_KEY))
...
law_query_results = EXECUTOR.query_log_analytics(
    ...
    workspace_id=config.require("LOG_ANALYTICS_WORKSPACE_ID", config.LOG_ANALYTICS_WORKSPACE_ID),
